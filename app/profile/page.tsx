...
export default function ProfilePage() {
  const { data: profile, isLoading: profileLoading, error: profileError } = useGetUserProfileQuery()
  const [updateProfile, { isLoading: updateProfileLoading }] = useUpdateUserProfileMutation()
  const [updateSupermarkets, { isLoading: updateSupermarketsLoading }] = useUpdateFrequentedSupermarketsMutation()
  ...
  const handleUpdateName = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error?.data?.message || "Impossibile aggiornare il nome",
      })
    }
  }

  const handleUpdateSupermarkets = async () => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Errore nell'aggiornamento",
        description: error?.data?.message || "Impossibile aggiornare i supermercati",
      })
    }
  }
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
          <Card className="overflow-hidden border-0 bg-gradient-to-br from-primary-purple/10 to-primary-pink/10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex space-x-2">
                    <Button
                      ...
                      disabled={!newName.trim() || updateProfileLoading}
            ...
            <CardContent className="space-y-4">
              {editingSupermarkets ? (
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    <Button
                      onClick={handleUpdateSupermarkets}
                      disabled={selectedSupermarkets.length === 0 || updateSupermarketsLoading}
                      className="flex-1 bg-gradient-to-r from-primary-purple to-primary-pink text-white"
                    >
                    ...
                    <Button
                      ...
                      className="flex-1"
                      disabled={updateSupermarketsLoading}
                    >
                      <X className="w-4 h-4 mr-2" />
                      Annulla
                    </Button>
