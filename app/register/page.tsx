...
export default function RegisterPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("https://server-supermarket-app.onrender.com/api/users/register", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: errorData.message || "Si è verificato un errore durante la registrazione",
        })
      }
    } catch (error) {
      toast({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50">
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        {/* Form Card */}
        <EnhancedCard variant="floating" className="animate-fade-in">
